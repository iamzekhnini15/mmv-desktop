...
/// <summary>
/// Ligne d'entrée du use case <see cref="CreateOrderUseCase"/> : porte les données nécessaires à la création
/// d'un <see cref="MMV.Domain.Entities.OrderItem"/> de commande fournisseur, y compris les paramètres optiques
/// (sphère / cylindre / axe / addition) actuellement renseignés par <c>OrderFormViewModel</c>.
/// </summary>
/// <remarks>
...
/// aucune devise.
/// </remarks>
public sealed class CreateOrderLineCommand
{
